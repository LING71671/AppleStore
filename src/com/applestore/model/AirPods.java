...
public class AirPods extends Product {
    private String noiseCancellation; // 降噪类型
    private int batteryLife; // 续航时间（小时）
    ...
    public String getDetails() {
        return String.format("AirPods %s，%s 技术，" +
               "续航时间最长可达 %d 小时，音质出色，使用便捷。",
               getModel(), noiseCancellation, batteryLife);
    }
    
    @Override
    public String toString() {
        return super.toString() + String.format(" | 降噪: %s | 续航: %d小时", 
               noiseCancellation, batteryLife);
    }
}
